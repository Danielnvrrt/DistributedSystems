    ...
    public void run() {
        ...
        while (true) {
            ...
            if (inputLine.startsWith("JOIN")) {
                ...
                // that was provided through the properties try { ChatClient.serverNodeInfo =
                ...
                try {
                    ...
                    Logger.getLogger(Sender.class.getName()).log(Level.SEVERE,
                            "Error connecting to server or opening or writing/reading object streams or closing connection",
                            ex);
                    continue;
                }
